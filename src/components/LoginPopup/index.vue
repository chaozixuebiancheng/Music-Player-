...
<template>
  <el-dialog v-model="dialogVisible" width="30%">
    <div class="p-7 rounded-lg shadow-lg text-center">
      ...
      <div class="m-auto p-2 border rounded-lg flex items-center justify-center h-[180px]">
        <img :src="qrImgUrl" alt="二维码登录" />
      </div>
      <div class="flex flex-col gap-1 items-center">
        <el-avatar v-if="qrStatus?.avatarUrl" class="mt-3" :src="qrStatus?.avatarUrl" shape="circle" />
