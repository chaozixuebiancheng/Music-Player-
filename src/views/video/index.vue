    ...
    <main class="grid md:grid-cols-6 gap-10 items-start p-4 md:px-6">
      <div class="col-span-4 grid gap-6">
        <div class="grid gap-4">
          <div class="rounded-xl overflow-hidden border aspect-video bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
            <videoPlay width="100%" height="100%" :title="mvDetails.name" :src="mvUrls" :poster="mvDetails.cover"
              type="video/mp4" />
          </div>
          <div class="py-2 grid gap-4">
            ...
            <div class="flex items-center justify-between">
              <div class="flex gap-3 items-center">
                <img v-if="mvDetails.artists && mvDetails.artists.length > 0" alt="Thumbnail"
                  class="rounded-full object-cover aspect-square border w-10 h-10"
                  :src="mvDetails.artists[0].img1v1Url" />
                <div class="text-sm">
                  <div class="font-semibold" v-if="mvDetails.artists && mvDetails.artists.length > 0">
        ...
        <div class="grid gap-8">
          ...
          <div class="grid gap-6">
            <div class="text-sm flex items-start gap-4" v-for="item in mvCommentsList.comments" :key="item.id"
              ref="observedElement">
      ...
      <div class="col-span-2 grid gap-6">
        <div class="flex items-start gap-4 relative group">
          ...
          <img alt="Thumbnail" class="aspect-video rounded-lg object-cover w-28 h-16"
