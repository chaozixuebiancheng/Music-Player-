...
import { logout } from '@/api' // 导入退出登录方法
...
<template>
  <header class="flex justify-between p-2 items-center border-b dark:border-gray-600">
    <div class="flex items-center">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex items-center">
          <el-input v-model="keyWord" placeholder="string" style="--el-input-border-radius: 30px; width: 300px"
            @keyup.enter="toSearch" class="dark:text-white">
            <template #prefix>
